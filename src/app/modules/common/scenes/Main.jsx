...
class Main extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      nextProps.snackbar &&
      this.props.snackbar.get('id') !== nextProps.snackbar.get('id')
    ) {
    ...
    if (
      ...
      !this.props.currentUser.get('socketConnected')
    ) {
      const user = {
  ...
  render() {
    ...
    const layout = () => {
      if (
        pathname === '/' &&
        (this.props.currentUserRole === roles.admin ||
          this.props.currentUserRole === roles.superAdmin)
      ) {
        return (
            <DashboardLayout
              ...
              this.props.routes.filter(
                item =>
                  removeArgsFromPath(item.path) === removeArgsFromPath(pathname)
              )[0]
            }
    ...
    return (
        <div className="app-layout">
          ...
          ? <div className={'global-loading global-loading--visible'} />
          : layout()}
...
const mapDispatchToProps = dispatch => ({
  ...
  showSnackbar: (title, message) =>
    dispatch(commonActions.showSnackbar(title, message)),
